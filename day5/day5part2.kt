...
class Computer {
    ...
    fun process(inst: IntArray, input: Int) {
        ...
        while(processing) {
            ...
            when(opCode) {
                ...
                5 -> opJumpIfTrue(instructions)
                6 -> opJumpIfFalse(instructions)
                7 -> opLessThan(instructions)
                8 -> opEquals(instructions)
                99 -> processing = false
    ...
    private fun opJumpIfTrue(instructions: IntArray) {
    ...
    private fun opJumpIfFalse(instructions: IntArray) {
    ...
    private fun opLessThan(instructions: IntArray) {
    ...
    private fun opEquals(instructions: IntArray) {
